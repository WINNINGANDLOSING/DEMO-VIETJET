...
const SearchResultPage = () => {
  ...
  const [currentSortingChoice, setCurrentSortingChoice] =
    useState("LowestToHighest");
  const handleOnChangeSorting = (e) => {
    return setCurrentSortingChoice(e.target.value);
  };
  return (
          ...
          <div className="flex justify-between">
            ...
            <div className="flex justify-center items-center space-x-3">
              ...
              <div className="flex relative">
                <select
                  className="appearance-none bg-productList border-[2px] w-[190px] h-[35px] flex relative  pl-2 rounded-[32px] border-solid"
                  value={currentSortingChoice}
                  onChange={handleOnChangeSorting}
                >
                  <option value="LowestToHighest">Giá từ Thấp - Cao</option>
                  <option value="HighestToLowest">Giá từ Cao - Thấp</option>
                </select>
                <img
                  src={expandOptionsRed}
          ...
          <div className="grid grid-cols-4 gap-y-5 gap-x-3 ">
            {currentSortingChoice === "LowestToHighest" &&
              resultData
                ...
                .map((data) => (
                  <Card key={data.id} data={data} /> // Ensure each Card has a unique key
                ))}
